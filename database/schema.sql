...
-- Database Schema v1.1 (MySQL 5.x + 8.x compatible)
-- ============================================================

CREATE DATABASE IF NOT EXISTS tol_cpd CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE tol_cpd;
...
-- Sample Products
INSERT INTO products (sku, name, category_id, brand, model, unit_cost, selling_price, current_stock, warranty_months) VALUES
...
-- Sample Customers
INSERT INTO customers (customer_code, name, nic, phone, email, address, city) VALUES
